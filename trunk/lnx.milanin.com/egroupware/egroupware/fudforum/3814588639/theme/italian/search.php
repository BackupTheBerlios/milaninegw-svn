...
<tr class="RowStyleA"><th colspan=2 width="100%" align="center">Nessun risultato</th></tr>
			...
			$search_data = '<br />
<table border="0" cellspacing="1" cellpadding="2" class="ContentTable">
<tr><th width="100%">Oggetto</th><th>Forum</th><th nowrap>Inviato</th></tr>
'.$search_data.'
</table>';
...
<table border="0" cellspacing="1" cellpadding="2" class="ContentTable">
<tr><th colspan=3 width="100%">Ricerca nel forum</th></tr>
<tr class="<?php echo alt_var('color_alt','RowStyleA','RowStyleB'); ?>"><td class="GenText">Cerca:</td><td colspan=2><input type="text" name="srch" value="<?php echo htmlspecialchars($srch); ?>"></td></tr>
<tr class="<?php echo alt_var('color_alt','RowStyleA','RowStyleB'); ?>"><td class="GenText">&nbsp;</td><td colspan=2><?php echo $search_options; ?></td></tr>
<tr class="<?php echo alt_var('color_alt','RowStyleA','RowStyleB'); ?>"><td class="GenText">Cerca nel forum:</td>
	<td colspan=2>
		<select name="forum_limiter"><option value="">Cerca in tutti i forum</option>
		<?php echo $forum_limit_data; ?>
		</select>
	</td>
</tr>
<tr class="<?php echo alt_var('color_alt','RowStyleA','RowStyleB'); ?>"><td class="GenText">Criterio di ricerca:</td><td colspan=2><select name="search_logic"><?php echo $logic_options; ?></select></td></tr>
<tr class="<?php echo alt_var('color_alt','RowStyleA','RowStyleB'); ?>"><td class="GenText">Mostra i risultati per data, in:</td><td colspan=2><select name="sort_order"><?php echo $sort_options; ?></select></td></tr>
<tr class="RowStyleC"><td class="GenText" align="right" colspan=3><input type="submit" class="button" name="btn_submit" value="Cerca"></td></tr>
</table></form>
