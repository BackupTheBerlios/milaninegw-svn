...
</td><td>&nbsp;<input type="submit" class="button" name="btn_vote" value="Vota il topic">
<input type="hidden" name="rate_thread_id" value="'.$frm->id.'">
	...
	if ($perms & 4096) {
		$lock_thread = !($frm->thread_opt & 1) ? '<a class="GenLink" href="ROOT}?t=mmod&amp;'._rsid.'&amp;th='.$th.'&amp;lock=1">Chiudi topic</a>&nbsp;|&nbsp;' : '<a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=mmod&amp;'._rsid.'&amp;th='.$th.'&amp;unlock=1">Riapri il topic</a>&nbsp;|&nbsp;';
	} else {
		$lock_thread = '';
	}

	$split_thread = ($frm->replies && $perms & 2048) ? '<a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=split_th&amp;'._rsid.'&amp;th='.$th.'">Spezza il Topic</a>&nbsp;|&nbsp;' : '';
	$post_reply = (!($frm->thread_opt & 1) || $perms & 4096) ? '&nbsp;<a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=post&amp;th_id='.$th.'&amp;reply_to='.$mid.'&amp;'._rsid.'"><img alt="Rispondi" src="/egroupware/fudforum/3814588639/theme/italian/images/post_reply.gif" /></a>' : '';
	$email_page_to_friend = $FUD_OPT_2 & 1073741824 ? '<a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=remail&amp;th='.$th.'&amp;'._rsid.'" title="Invia l&#39;indirizzo di questa pagina ai tuoi amici via email">Email ad un amico</a>&nbsp;' : '';
		...
		while ($stack_cnt > 0) {
			...
			if (isset($cur->subject) && empty($cur->sub_shown)) {
				...
				if (_uid && $cur->post_stamp > $usr->last_read && $cur->post_stamp > $frm->last_view) {
					$read_indicator = '<img src="/egroupware/fudforum/3814588639/theme/italian/images/unread.png" width=32 height=32 alt="Unread Message" title="Unread Message" />';
				} else {
					$read_indicator = '<img src="/egroupware/fudforum/3814588639/theme/italian/images/read.png" width=32 height=32 alt="Read Message" title="Read Message" />';
				}
...
<div class="TopBy">Da: '.$user_login.' on '.strftime("%a, %d %B %Y %H:%M", $cur->post_stamp).'</div></td>' : '<tr class="'.alt_var('tree_alt','RowStyleA','RowStyleB').'">
<td>'.$read_indicator.'</td>
<td valign="top" width="100%" class="Gentext" nowrap style="padding-left: '.$width.'px">
...
<div class="TopBy">Da: '.$user_login.' on '.strftime("%a, %d %B %Y %H:%M", $cur->post_stamp).'</div></td>
</tr>';
				} else {
					$tree_data .= $cur->id == $mid ? '<tr class="RowStyleC">
<td>'.$read_indicator.'</td>
...
<td valign="bottom" align="right"><a href="/egroupware/fudforum/3814588639/index.php?t=msg&amp;th=<?php echo $th; ?>&amp;<?php echo _rsid; ?>#msg_<?php echo $mid; ?>" class="GenLink"><img alt="Ritorna alla vista flat (default)" title="Ritorna alla vista flat (default)" src="/egroupware/fudforum/3814588639/theme/italian/images/flat_view.gif" /></a>&nbsp;<a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=post&amp;frm_id=<?php echo $frm->forum_id; ?>&amp;<?php echo _rsid; ?>"><img alt="Crea un nuovo topic" src="/egroupware/fudforum/3814588639/theme/italian/images/new_thread.gif" /></a><?php echo $post_reply; ?></td>
</tr>
</table>
<table border="0" cellspacing="0" cellpadding="0" class="ContentTable"><?php echo $message_data; ?></table>
<div align=center class="GenText">[<a href="#tree_view" class="GenLink" title="Vedi la lista dei messaggi">Indice dei messaggi</a>]</div>
<p>
