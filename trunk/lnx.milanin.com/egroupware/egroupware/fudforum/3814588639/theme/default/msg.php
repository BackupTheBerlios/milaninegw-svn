...
'.$drawmsg_file_attachments.'
	...
	if (!$hide_controls) {
		...
		if ($obj->user_id) {
			...
			$private_msg_link = $o1 & 1024 ? '<a class="GenLink" href="/egroupware/index.php?menuaction=messenger.uimessenger.compose&amp;'._rsid.'&amp;message_to='.$user_login.'&amp;'._rsid.'"><img alt="Send a private message to this user" title="Send a private message to this user" src="/egroupware/fudforum/3814588639/theme/default/images/msg_pm.gif" /></a>' : '';
...
fud_msg_focus("'.$mid.'");
	...
	if (_uid) {
		...
		if (($total - $_GET['th']) > $count) {
			$first_unread_message_link = '| <a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=msg&amp;unread=1&amp;th='.$_GET['th'].'&amp;'._rsid.'" title="Go to the 1st unread message inside this topic">Go to unread message(s)</a>&nbsp;';
		} else {
			$first_unread_message_link = '';
		}
		$subscribe_status = $frm->subscribed ? '| <a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=msg&amp;th='.$_GET['th'].'&amp;notify='.$usr->id.'&amp;'._rsid.'&amp;opt=off&amp;start='.$_GET['start'].'" title="Stop receiving notifications about new posts in this topic">Unsubscribe from topic</a>&nbsp;' : '| <a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=msg&amp;th='.$_GET['th'].'&amp;notify='.$usr->id.'&amp;'._rsid.'&amp;opt=on&amp;start='.$_GET['start'].'" title="Receive notification about new posts inside this topic">Subscribe to topic</a>&nbsp;';
	} else {
		$first_unread_message_link = $subscribe_status = '';
	}

	ses_update_status($usr->sid, 'Browsing topic <a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=msg&amp;th='.$frm->id.'">'.$frm->subject.'</a>', $frm->forum_id);
...
<input type="hidden" name="rate_thread_id" value="'.$frm->id.'">'._hs.'
	...
	$post_reply = (!($frm->thread_opt & 1) || $perms & 4096) ? '&nbsp;<a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=post&amp;th_id='.$_GET['th'].'&amp;reply_to='.$frm->root_msg_id.'&amp;'._rsid.'&amp;start='.$_GET['start'].'"><img src="/egroupware/fudforum/3814588639/theme/default/images/post_reply.gif" alt="Submit Reply" /></a>' : '';
	$threaded_view = $FUD_OPT_3 & 2 ? '' : '<a href="/egroupware/fudforum/3814588639/index.php?t=tree&amp;th='.$_GET['th'].'&amp;'._rsid.'" class="GenLink"><img title="Switch to threaded view of this topic" alt="Switch to threaded view of this topic" src="/egroupware/fudforum/3814588639/theme/default/images/tree_view.gif" /></a>&nbsp;';
	$email_page_to_friend = $FUD_OPT_2 & 1073741824 ? '<a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=remail&amp;th='.$_GET['th'].'&amp;'._rsid.'" title="Send the URL to this page to your friend(s) via email">Email to friend</a>&nbsp;' : '';

	if ($perms & 4096) {
		$lock_thread = !($frm->thread_opt & 1) ? '<a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=mmod&amp;'._rsid.'&amp;th='.$_GET['th'].'&amp;lock=1">Lock Topic</a>&nbsp;|&nbsp;' : '<a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=mmod&amp;'._rsid.'&amp;th='.$_GET['th'].'&amp;unlock=1">Unlock Topic</a>&nbsp;|&nbsp;';
	} else {
		$lock_thread = '';
	}

	$split_thread = ($frm->replies && $perms & 2048) ? '<a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=split_th&amp;'._rsid.'&amp;th='.$_GET['th'].'">Split Topic</a>&nbsp;|&nbsp;' : '';
...
<td valign="bottom" align="right"><?php echo $threaded_view; ?><a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=post&amp;frm_id=<?php echo $frm->forum_id; ?>&amp;<?php echo _rsid; ?>"><img alt="Create a new topic" src="/egroupware/fudforum/3814588639/theme/default/images/new_thread.gif" /></a><?php echo $post_reply; ?></td>
</tr>
</table>
...
<td align="right" class="GenText" valign="bottom" nowrap><?php echo $threaded_view; ?><a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=post&amp;frm_id=<?php echo $frm->forum_id; ?>&amp;<?php echo _rsid; ?>"><img alt="Create a new topic" src="/egroupware/fudforum/3814588639/theme/default/images/new_thread.gif" /></a><?php echo $post_reply; ?></td>
</tr>
</table>
