...
<tr class="RowStyleA">
	<td align="left"><b>New topic title:</b></td>
...
<tr class="RowStyleC">
	<td colspan=2 align="center">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="submit" class="button" name="btn_unselected" value="Split non-selected messages">
	</td>
</tr>
</table>
<br />
<table border="0" cellspacing="1" cellpadding="2" class="ContentTable">
<tr><th nowrap>Select</th><th width="100%">Messages</th></tr>
<?php echo $msg_entry; ?>
</table>
<br />
<table border="0" cellspacing="1" cellpadding="2" class="ContentTable">
