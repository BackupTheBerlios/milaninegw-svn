...
<td class="GenText" nowrap>Registered On <?php echo strftime("%a, %d %B %Y", $u_reg_date); ?></td><td class="GenText" nowrap>Post Count <?php echo $u_pcount; ?></td></tr>
<tr><th width="100%">Subject</th><th nowrap>Forum:</th><th nowrap><a class="thLnk" href="/egroupware/fudforum/3814588639/index.php?t=showposts&amp;so=<?php echo $SORT_ORDER_R; ?>&amp;id=<?php echo $uid; ?>&amp;<?php echo _rsid; ?>">Date Posted</a></th></tr>
<?php echo $post_entry; ?>
</table>
<?php echo $pager; ?>
<?php echo $page_stats; ?>
