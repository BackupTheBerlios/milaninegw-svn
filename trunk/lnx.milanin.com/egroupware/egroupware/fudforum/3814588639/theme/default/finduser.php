...
function read_msg_body($off, $len, $file_id)
{
	...
	while ($r = db_rowobj($c)) {
		...
		$find_user_data .= '<tr class="'.alt_var('finduser_alt','RowStyleA','RowStyleB').'"><td nowrap class="GenText"><a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=usrinfo&amp;id='.$r->id.'&amp;'._rsid.'">'.$r->alias.'</a></td><td align="center" nowrap>'.$r->posted_msg_count.'</td><td class="DateText" nowrap>'.strftime("%a, %d %B %Y", $r->join_date).'</td><td nowrap class="GenText"><a href="/egroupware/fudforum/3814588639/index.php?t=showposts&amp;id='.$r->id.'&amp;'._rsid.'" class="GenLink"><img alt="" src="/egroupware/fudforum/3814588639/theme/default/images/show_posts.gif" /></a>
'.$email_link.'
'.$pm_link.'
'.$homepage_link.'</td>'.$admi.'</tr>';
	...
	if (!$find_user_data) {
		$colspan = $adm ? 5 : 4;
		$find_user_data = '<tr class="RowStyleA"><td colspan="'.$colspan.'" width="100%" class="GenText">No Such User</td></tr>';
	}
...
<tr class="RowStyleA"><td class="GenText" nowrap>By Login:</td><td class="GenText" width="100%"><input type="text" name="usr_login" value="<?php echo htmlspecialchars($usr_login); ?>"></td></tr>
<tr class="RowStyleB"><td class="GenText" nowrap>By Email:</td><td width="100%"><input type="text" name="usr_email" value="<?php echo htmlspecialchars($usr_email); ?>"></td></tr>
<tr class="RowStyleA"><td class="GenText" align="right" colspan=2><font class="SmallText">The search engine will automatically add * mask to your query. ex. to search for all users who&#39;s login begins with an &#39;a&#39;, enter &#39;a&#39; into the search box.</font> <input type="submit" class="button" name="btn_submit" value="Find"></td></tr>
</table><input type="hidden" name="t" value="finduser"></form>
<img src="blank.gif" alt="" height=2 width=1 /><br />
<table border="0" cellspacing="1" cellpadding="2" class="ContentTable">
<tr>
<th width="100%"><a class="thLnk" href="/egroupware/fudforum/3814588639/index.php?t=finduser&amp;usr_login=<?php echo urlencode($usr_login); ?>&amp;usr_email=<?php echo urlencode($usr_email); ?>&amp;us=1&amp;btn_submit=Find&amp;<?php echo _rsid; ?>">User</a></th><th nowrap><a href="/egroupware/fudforum/3814588639/index.php?t=finduser&amp;usr_login=<?php echo urlencode($usr_login); ?>&amp;<?php echo _rsid; ?>&amp;usr_email=<?php echo urlencode($usr_email); ?>&amp;pc=1&amp;btn_submit=Find" class="thLnk">Post Count</a></th><th nowrap><div align="center"><a href="/egroupware/fudforum/3814588639/index.php?t=finduser&amp;usr_login=<?php echo urlencode($usr_login); ?>&amp;<?php echo _rsid; ?>&amp;usr_email=<?php echo urlencode($usr_email); ?>&amp;btn_submit=Find" class="thLnk">Join Date</a></div></th><th align="center">Action</th><?php echo $admin_opts; ?>
</tr>
