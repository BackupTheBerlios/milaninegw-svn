				...
				while ($stack_cnt > 0) {
					...
					if (isset($cur->subject) && empty($cur->sub_shown)) {
						if ($TREE_THREADS_MAX_DEPTH > $lev) {
							$thread_poll_indicator		= $cur->poll_id		? 'Poll:&nbsp;'	: '';
							$thread_attach_indicator	= $cur->attach_cnt	? '<img src="/egroupware/fudforum/3814588639/theme/default/images/attachment.gif" alt="" />'	: '';
							...
							if (_uid) {
								if ($usr->last_read < $cur->post_stamp && $cur->post_stamp>$cur->last_view) {
									$thread_read_status = $cur->thread_opt & 1 ? '<img src="/egroupware/fudforum/3814588639/theme/default/images/unreadlocked.png" width=32 height=32 title="Locked topic with unread messages" alt="" />'	: '<img src="/egroupware/fudforum/3814588639/theme/default/images/unread.png" width=32 height=32 title="This topic contains messages you have not yet read" alt="" />';
								} else {
									$thread_read_status = $cur->thread_opt & 1 ? '<img src="/egroupware/fudforum/3814588639/theme/default/images/readlocked.png" width=32 height=32 title="This topic has been locked" alt="" />'	: '<img src="/egroupware/fudforum/3814588639/theme/default/images/read.png" width=32 height=32 title="This topic has no unread messages" alt="" />';
								}
							} else {
...
<div class="TopBy">By: '.$user_link.' on '.strftime("%a, %d %B %Y %H:%M", $cur->post_stamp).'</div></td>
</tr>';
...
<td valign="bottom" align="right" class="GenText"><a href="/egroupware/fudforum/3814588639/index.php?t=thread&amp;frm_id=<?php echo $frm->id; ?>&amp;<?php echo _rsid; ?>" class="GenLink"><img alt="Return to the default flat view" title="Return to the default flat view" src="/egroupware/fudforum/3814588639/theme/default/images/flat_view.gif" /></a>&nbsp;<a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=post&amp;frm_id=<?php echo $frm->id; ?>&amp;<?php echo _rsid; ?>"><img src="/egroupware/fudforum/3814588639/theme/default/images/new_thread.gif" alt="Create a new topic" /></a></td>
</tr></table>
...
<td align="right" class="GenText" valign="bottom" nowrap><a href="/egroupware/fudforum/3814588639/index.php?t=thread&amp;frm_id=<?php echo $frm->id; ?>&amp;<?php echo _rsid; ?>" class="GenLink"><img alt="Return to the default flat view" title="Return to the default flat view" src="/egroupware/fudforum/3814588639/theme/default/images/flat_view.gif" /></a>&nbsp;<a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=post&amp;frm_id=<?php echo $frm->id; ?>&amp;<?php echo _rsid; ?>"><img src="/egroupware/fudforum/3814588639/theme/default/images/new_thread.gif" alt="Create a new topic" /></a></td>
</tr>
</table>
