<?php
	...
	*  option) any later version.                                              *
	...
	/* $Id: navbar.inc.php,v 1.1.2.1 2004/09/28 10:17:33 bgigon Exp $ */
...
// table width=100% fixed layout bug (ndee130204)
		...
		function sidebox_menu_item($item_link='',$item_text='')
		{
			...
			else
			{
				...
				{
					$var['lang_item'] = ucfirst(lang($item_text));

					$buffer_begin = substr($var['lang_item'], 0, 1);
					$buffer_end   = substr($var['lang_item'], 1);

					$var['lang_item'] = "<b>" . $buffer_begin . "</b>" . $buffer_end;
