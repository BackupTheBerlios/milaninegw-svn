...
<tr bgcolor="#D3DCE3">
	<td colspan="3" align="left">
		<a href="javascript:check_all('{form_name}')"><img src="/egroupware/email/templates/default/images/check.gif" border="0" height="16" width="21"></a>&nbsp;&nbsp;
	<a href="javascript:do_action('{form_name}', 'delall')"><img src="/egroupware/email/templates/default/images/evo/trash-24.gif" border="0" alt="[image]">&nbsp;Delete</a>
	</td>
