...
// ------------------------------------------------------------------------- //
// CVS version: $Id: thumbnails.php,v 1.3 2004/08/24 20:49:04 joestewart Exp $
// ------------------------------------------------------------------------- //
...
if (is_numeric($album)) {
    ...
    if (mysql_num_rows($result) > 0) {
        ...
        cpg_breadcrumb($actual_cat, $breadcrumb, $breadcrumb_text);
        $cat = - $album;
    }
    ...
    if ($cat < 0) {
        ...
        cpg_breadcrumb($cat, $breadcrumb, $breadcrumb_text);
    }
}
