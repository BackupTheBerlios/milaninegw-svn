...
// ------------------------------------------------------------------------- //
// CVS version: $Id: init.inc.php,v 1.4 2004/08/24 20:49:07 joestewart Exp $
// ------------------------------------------------------------------------- //
...
// User CMS integration
// Uncomment the applicable line if you want to use it
// define('CMS_INTEGRATION', 'phpslash');
// define('CMS_INTEGRATION', 'back-end');
define('CMS_INTEGRATION', 'egroupware');
...
// User CMS 
if (defined('CMS_INTEGRATION')) require 'bridge/' . CMS_INTEGRATION . '.inc.php';
// debug("init", 'bridge/' . CMS_INTEGRATION . '.inc.php');
...
if (defined('CMS_INTEGRATION')) {
    cms_authenticate();
    // debug("init", "CMS authenticated", "now");
