...
// ------------------------------------------------------------------------- //
// CVS version: $Id: theme.php,v 1.5 2004/08/24 20:49:15 joestewart Exp $
// ------------------------------------------------------------------------- //
...
function theme_main_menu1()
{
    ...
    if (defined('CMS_INTEGRATION')) {
       global $cms_login_tgt, $cms_logout_tgt;
       $login_tgt = $cms_login_tgt;
       $logout_tgt = $cms_logout_tgt;
    } else {
