...
<table border=0 cellspacing=0 cellpadding=3 width="100%">
	<tr>
		<td align=left nowrap valign=top>
			...
			<b>Reported By:</b> '.$user_login.'<br />
			<b>On:</b> '.strftime("%a, %d %B %Y %H:%M", $obj->report_stamp).'
			</font>
		</td>
		<td align=center width="100%" valign=top>
			<font class="SmallText"><b>Reason</b><br /></font>
			<table border=1 cellspacing=1 cellpadding=0><tr><td align="left">&nbsp;'.$obj->report_reason.' &nbsp;</td></tr></table>
			
		</td>
		<td nowrap>[<a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=reported&amp;'._rsid.'&amp;del='.$obj->report_id.'">Delete Report</a>]</td>
	</tr>
	
	<tr>
		<td colspan=3><font class="SmallText"><b>In topic:</b></font> <a href="/egroupware/fudforum/3814588639/index.php?t='.d_thread_view.'&amp;goto='.$obj->id.'&amp;'._rsid.'" target="_blank">'.$obj->thread_subject.'</a></td>
	</tr>
</table>
</td></tr>
'.$message;
