	...
	while ($r = db_rowarr($c)) {
		...
		if ($r[3]) {
			...
			if (!$r[9]) {
				...
				$last_post = (!($usr->users_opt & 1048576) && !$r[11] && empty($limit[$r[10]])) ? 'You do not have appropriate permissions needed to see this topic.' : ''.strftime("%a, %d %B %Y %H:%M", $r[9]).'<br />
...
<div align="center" class="GenText">[<a href="/egroupware/fudforum/3814588639/index.php?t=actions&rand=<?php echo $rand_val; ?>&<?php echo _rsid; ?>" class="GenLink">Refresh List</a>]</div>
<p>
<table border="0" cellspacing="1" cellpadding="2" class="ContentTable">
<tr><th>User</th><th>Action</th><th>Time</th><th>Last Post</th></tr>
