...
}function draw_user_link($login, $type, $custom_color='')
{
	...
	ses_update_status($usr->sid, 'Elenco di persone che sono state sul forum oggi.');
...
<a href="/egroupware/fudforum/3814588639/index.php?t='.d_thread_view.'&amp;goto='.$r[5].'&amp;'._rsid.'">'.$r[6].'</a>';
			...
			$last_post = 'Non disponi dei permessi necessari per visualizzare questo topic.';
		}
...
<tr><th>Utente</th><th>Ultima visita</th><th>Ultimo post</th></tr>
