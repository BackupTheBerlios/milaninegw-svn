...
<table border=0 cellspacing=0 cellpadding=3 width="100%">
	<tr class="RowStyleB">
		<td align=left nowrap valign=top>
			<font class="SmallText"><b>Spostamento del topic richiesto da:</b> <a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=usrinfo&amp;id='.$obj->req_by.'&amp;'._rsid.'">'.$obj->alias.'</a><br /></font>
		</td>
		<td align=center width="100%" valign=top>
			<font class="SmallText">
			<b>Motivazione per lo spostamento del topic:</b><br />
	...
	<tr class="RowStyleC">
		<td colspan=2>
			<table border=0 cellspacing=0 cellpadding=3 width="100%">
			<tr>
				<td align="left"><font size="-1"><b>Forum di partenza:</b> '.$obj->sf_name.'<br /><b>Forum di destinazione:</b> '.$obj->df_name.'<br /><b>Topic:</b> <a href="/egroupware/fudforum/3814588639/index.php?t=msg&amp;'._rsid.'&amp;th='.$obj->th.'">'.$obj->subject.'</a></font></td>
				<td align="right">[<a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=thr_exch&amp;appr='.$obj->id.'&amp;'._rsid.'">accetta il topic</a>]&nbsp;&nbsp;[<a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=thr_exch&amp;decl='.$obj->id.'&amp;'._rsid.'">rifiuta il topic</a>]</td>
			</tr>
			</table>
		</td>
	</tr>		
		...
		if (!$thr_exch_data) {
			$thr_exch_data = '<tr><td class="RowStyleA" align="center">Non ci sono topic in attesa di approvazione.</td></tr>';
		}
	}
