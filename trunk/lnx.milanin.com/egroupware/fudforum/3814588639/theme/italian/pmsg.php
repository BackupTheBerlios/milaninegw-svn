	...
	}function tmpl_draw_select_opt($values, $names, $selected, $normal_tmpl, $selected_tmpl)
{
	...
	return $options;
}$folders = array(1=>'Posta ricevuta', 2=>'Saved', 4=>'Bozze', 3=>'Posta inviata', 5=>'Cestino');

function tmpl_cur_ppage($folder_id, $folders, $msg_subject='')
{
	if (!$folder_id || (!$msg_subject && $_GET['t'] == 'ppost')) {
		$user_action = 'Scrivi un messaggio personale';
	} else {
		$user_action = $msg_subject ? '<a href="/egroupware/fudforum/3814588639/index.php?t=pmsg&amp;folder_id='.$folder_id.'&amp;'._rsid.'" class="GenLink">'.$folders[$folder_id].'</a> &raquo; '.$msg_subject : 'Sfoglia <b>'.$folders[$folder_id].'</b> cartella';
	}

	return '<font class="SmallText"><a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=pmsg&amp;'._rsid.'">Messaggi personali</a>&nbsp;&raquo;&nbsp;'.$user_action.'</font><br /><img src="blank.gif" alt="" height=4 width=1 /><br />';
}class fud_pmsg
{
...
<tr class="tab">'.$tabs.'</tr>
	...
	$author_dest_col = $folder_id == 3 ? 'Destinatario' : 'Mittente';
	...
	while ($obj = db_rowobj($c)) {
		switch ($obj->fldr) {
			case 1:
			case 2:
				$action = '<a href="/egroupware/fudforum/3814588639/index.php?t=ppost&amp;'._rsid.'&amp;reply='.$obj->id.'" class="GenLink"><img src="/egroupware/fudforum/3814588639/theme/italian/images/msg_reply.gif" alt="" /></a>&nbsp;<a href="/egroupware/fudforum/3814588639/index.php?t=ppost&amp;quote='.$obj->id.'&amp;'._rsid.'" class="GenLink"><img src="/egroupware/fudforum/3814588639/theme/italian/images/msg_quote.gif" alt="" /></a>&nbsp;<a href="/egroupware/fudforum/3814588639/index.php?t=ppost&amp;forward='.$obj->id.'&amp;'._rsid.'" class="GenLink"><img src="/egroupware/fudforum/3814588639/theme/italian/images/msg_forward.gif" alt="" /></a>';
				break;
			case 3:
				...
				break;
			case 5:
				$action = '<a href="/egroupware/fudforum/3814588639/index.php?t=ppost&amp;'._rsid.'&amp;forward='.$obj->id.'" class="GenLink"><img src="/egroupware/fudforum/3814588639/theme/italian/images/msg_forward.gif" alt="" /></a>';
				break;
			case 4:
				$action = '<a href="/egroupware/fudforum/3814588639/index.php?t=ppost&amp;'._rsid.'&amp;msg_id='.$obj->id.'" class="GenLink"><img src="/egroupware/fudforum/3814588639/theme/italian/images/msg_edit.gif" alt="" /></a>';
				break;
		}
		...
		$pmsg_status = $obj->read_stamp ? '<img src="/egroupware/fudforum/3814588639/theme/italian/images/pmsg_read.png" width=32 height=32 alt="Leggi messaggio personale" title="Leggi messaggio personale" />' : '<img src="/egroupware/fudforum/3814588639/theme/italian/images/pmsg_unread.png" width=32 height=32 alt="Messaggio personale non letto" title="Messaggio personale non letto" />';
		if ($obj->pmsg_opt & 4 && $obj->pmsg_opt & 16 && $obj->duser_id == _uid && $obj->ouser_id != _uid) {
			$deny_recipt = '<font class="SmallText">&nbsp;&nbsp;[<a href="/egroupware/fudforum/3814588639/index.php?t=pmsg_view&amp;'._rsid.'&amp;dr=1&amp;id='.$obj->id.'" class="GenLink" title="Non inviare una conferma della lettura di questo messaggio">rifiuta la richiesta di conferma</a>]</font>';
		} else {
			$deny_recipt = '';
		}
		...
		if ($FUD_OPT_2 & 32 && (!($obj->users_opt & 32768) || $usr->users_opt & 1048576)) {
			...
			if (($obj->time_sec + $LOGEDIN_TIMEOUT * 60) > __request_timestamp__) {
				$online_indicator = '<img src="/egroupware/fudforum/3814588639/theme/italian/images/online.gif" alt="'.$user_login.' è attualmente online" title="'.$user_login.' è attualmente online" />&nbsp;';
			} else {
				$online_indicator = '<img src="/egroupware/fudforum/3814588639/theme/italian/images/offline.gif" alt="'.$user_login.'  è attualmente offline" title="'.$user_login.'  è attualmente offline" />&nbsp;';
			}
		} else {
			$online_indicator = '';
		}
		...
		if ($obj->pmsg_opt & 64) {
			$msg_type ='<font class="SmallText">(risposto)</font>&nbsp;';
		} else if ($obj->pmsg_opt & 32) {
			$msg_type = '';
		} else {
			$msg_type ='<font class="SmallText">(inoltrato)</font>&nbsp;';
		}
...
<td align="center" class="GenText"><input type="checkbox" name="sel[]" value="'.$obj->id.'"'.$checked.'></td></tr>';
	...
	if (!$private_msg_entry) {
		...
		$btn_action = $folder_id == 5 ? 'Ripristina in:' : 'Sposta in:';
...
&nbsp;&nbsp;&nbsp;<input type="submit" class="button" name="btn_delete" value="Cancella"></td></tr>';
	}
...
<tr>
	<td colspan="3" width="100%" class="RowStyleA" nowrap><span class="SmallText">Le tue cartelle di MP sono piene al <?php echo $percent_full; ?>%.</span></td>
</tr>
<tr>
...
<div align="right"><a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=ppost&amp;<?php echo _rsid; ?>"><img src="/egroupware/fudforum/3814588639/theme/italian/images/new_pm.gif" alt="" /></a></div><img src="blank.gif" alt="" width=1 height=2 />
<?php echo $tabs; ?>
...
Cartella: <select name="folder_id" onChange="javascript: document.priv_frm.submit();">
<?php echo $select_options_cur_folder; ?>
</select> <input type="submit" class="button" name="sel_folder" value="Vai">
</td></tr>
<tr>
	<th>&nbsp;</th>
	<th width="100%">Oggetto</th>
	<th align="center"><?php echo $author_dest_col; ?></th>
	<th align="center">Ora</th>
	<th align="center">Azione</th>
	<th nowrap>Selezionato [<a href="/egroupware/fudforum/3814588639/index.php?t=pmsg&amp;folder_id=<?php echo $folder_id; ?>&amp;<?php echo _rsid; ?>&amp;all=<?php echo $all_v; ?>" class="thLnk"><?php echo $desc; ?></a>]</th>
</tr>
<?php echo $private_msg_entry; ?>
<?php echo $private_tools; ?>
</table></form>
<?php echo $page_pager; ?>
<div style="padding-top: 2px;" align="right"><a class="GenLink" href="/egroupware/fudforum/3814588639/index.php?t=ppost&amp;<?php echo _rsid; ?>"><img src="/egroupware/fudforum/3814588639/theme/italian/images/new_pm.gif" alt="" /></a></div>
<?php echo $page_stats; ?>
</td></tr></table>
