...
<tr class="'.alt_var('page_alt','RowStyleA','RowStyleB').'"><td class="GenText" colspan=2 align="right"><input type="submit" class="button" name="submit" value="Spedisci email"></td></tr>';
		...
		$form_data = '<tr class="'.alt_var('page_alt','RowStyleA','RowStyleB').'"><td class="GenText" align="center"><font class="SmallText">Copia questo messaggio in un programma di posta elettronica.</font></td></tr>
<tr class="'.alt_var('page_alt','RowStyleA','RowStyleB').'"><td class="GenText"><textarea name="body" rows="19" cols="78">'.$body.'</textarea></td></tr>
<tr class="'.alt_var('page_alt','RowStyleA','RowStyleB').'"><td class="GenText" align="right"><input type="submit" class="button" name="done" value="Fatto"></td></tr>';
	}
...
<tr><th colspan=2>Segnala questo topic ad un amico</th></tr>
<?php echo $form_data; ?>
</table>
