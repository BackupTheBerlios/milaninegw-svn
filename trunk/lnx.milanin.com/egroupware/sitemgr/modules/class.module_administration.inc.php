<?php
	...
	*  option) any later version.                                              *
	...
	/* $Id: class.module_administration.inc.php,v 1.6 2004/02/10 14:56:33 ralfbecker Exp $ */
...
class module_administration extends Module
{
	...
	function get_content(&$arguments,$properties)
	{
		...
		$content .= "</select>\n</form>\n" .
			...
			'&nbsp;&nbsp;<strong><big>&middot;</big></strong><a href="' . phpgw_link('/logout.php?phpgw_forward=/sitemgr/sitemgr-site') .
			'">' . lang('Logout') . "</a></p>\n";
		return $content;
	}
