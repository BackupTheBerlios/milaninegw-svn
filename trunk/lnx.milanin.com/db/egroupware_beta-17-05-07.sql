...
-- 
-- Host: localhost
-- Generation Time: May 17, 2007 at 03:16 PM
-- Server version: 5.0.37
-- PHP Version: 4.4.6
-- 
-- Database: `egroupware_beta`
-- 
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2121 ;
...
-- 
-- Table structure for table `LUM_UserCategoryWatch`
-- 
...
CREATE TABLE `members_profile_data` (
  ...
  PRIMARY KEY  (`ident`),
  KEY `owner` (`owner`,`access`,`name`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3027 ;

-- --------------------------------------------------------

-- 
-- Table structure for table `members_profile_views`
-- 

CREATE TABLE `members_profile_views` (
  `ident` int(11) NOT NULL auto_increment,
  ...
  PRIMARY KEY  (`ident`),
  UNIQUE KEY `owner` (`owner`,`viewer`,`referral`)
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4543 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=25234 ;
...
-- 
-- Table structure for table `members_videos`
-- 

CREATE TABLE `members_videos` (
  `ident` int(11) NOT NULL auto_increment,
  `owner` int(11) NOT NULL default '0',
  `filename` varchar(128) NOT NULL default '',
  `description` varchar(255) NOT NULL default '',
  `video_info` varchar(256) character set utf8 collate utf8_unicode_ci default 'none',
  `video_thumb` varchar(256) NOT NULL default '-1',
  PRIMARY KEY  (`ident`),
  KEY `owner` (`owner`,`filename`,`description`)
...
CREATE TABLE `phpgw_cpg_ecards` (
  ...
  PRIMARY KEY  (`eid`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Used to log ecards' AUTO_INCREMENT=1 ;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Used to store the file extensions';
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Holds temporary file data for multiple file uploads';
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2905 ;
...
CREATE TABLE `phpgw_fud_index` (
  ...
  KEY `msg_id` (`msg_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=100666 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3252 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=12997 ;
...
CREATE TABLE `phpgw_fud_ses` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3636 ;
...
CREATE TABLE `phpgw_fud_title_index` (
  ...
  KEY `word_id` (`word_id`,`msg_id`),
  KEY `msg_id` (`msg_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3976 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2209 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8720 ;
